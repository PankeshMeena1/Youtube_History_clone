...
const App = () => {
  ...
  return (
    <div className={`app ${menuOpen ? 'menu-open' : ''}`}>
      <div className="app-nav">
        <button className="app-nav-button" onClick={toggleMenu}>
          <FaBars fontSize={"30px"} />
        </button>
        <div className="app-nav-logo">
          <img src="https://www.youtube.com/favicon.ico" alt="YouTube Logo" />
        ...
        <div className="app-content-main">
          ...
          <div className="app-content-main-videos">
            <div className="app-content-main-video">
              ...
              <div className="app-content-main-video-info">
                <div className="app-content-main-video-title">
                  SQL - Complete Course in 3 Hours | SQL One Shot using...
                </div>
                <div className="app-content-main-video-channel">
                  Apna College <i className="fas fa-check-circle"></i> 6.4M views
                </div>
                <div className="app-content-main-video-description">
                  You can join the NEW Web Development batch using the below link. <i className="fas fa-fire-alt"></i> Delta 3.0 (Full Stack Web Development) :...
                </div>
              </div>
              <div className="app-content-main-video-actions">
                <button className="app-content-main-video-action">
            ...
            <div className="app-content-main-video">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVMQOZv4I7mstCY_lpIie5Q_Wr6MWLstHklQ&s" alt="Video Thumbnail" />
              <div className="app-content-main-video-info">
                <div className="app-content-main-video-title">
                ...
                <div className="app-content-main-video-description">
                Hi Guys, In this video, I have explained step-by-step  Express JS, SQL, HTML...
                </div>
              </div>
              <div className="app-content-main-video-actions">
                <button className="app-content-main-video-action">
            ...
            <div className="app-content-main-video">
              ...
              <div className="app-content-main-video-info">
                <div className="app-content-main-video-title">
                  Node JS MySQL Tutorials #1 | How To Connect Node To MySQL...
                </div>
                <div className="app-content-main-video-channel">
                  What About Coding. 9.5K views
                </div>
                <div className="app-content-main-video-description">
                Hi Guys, In this video, I have explained step-by-step  NodeJS, Express JS, SQL, HTML...
                </div>
              </div>
              <div className="app-content-main-video-actions">
                <button className="app-content-main-video-action">
            ...
            <div className="app-content-main-video">
              ...
              <div className="app-content-main-video-info">
                ...
                <div className="app-content-main-video-description">
                Hi Guys, In this video, I have explained step-by-step  JS, SQL, HTML...
                </div>
              </div>
              <div className="app-content-main-video-actions">
                <button className="app-content-main-video-action">
            ...
            <div className="app-content-main-video">
              ...
              <div className="app-content-main-video-info">
                ...
                <div className="app-content-main-video-description">
                Hi Guys, In this video, I have explained step-by-step SQL, HTML...
                </div>
              </div>
              <div className="app-content-main-video-actions">
                <button className="app-content-main-video-action">
            ...
            <div className="app-content-main-video">
              ...
              <div className="app-content-main-video-info">
                ...
                <div className="app-content-main-video-description">
                Hi Guys, In this video, I have explained step-by-step ..
                </div>
              </div>
              <div className="app-content-main-video-actions">
                <button className="app-content-main-video-action">
